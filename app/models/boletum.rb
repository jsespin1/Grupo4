class Boletum < ActiveRecord::Base
    ...
    def self.getUrl(boletaId)
        ...
        if Rails.env == 'development'
            url = "http://integracion-2016-dev.herokuapp.com/web/pagoenlinea?callbackUrl=http%3A%2F%2Flocalhost%3A3000%2Fspree%2Fexito&cancelUrl=http%3A%2F%2Flocalhost%3A3000%2Fspree%2Ffalla&boletaId="+boletaId
        else
            url = "http://integracion-2016-prod.herokuapp.com/web/pagoenlinea?callbackUrl=http%3A%2F%2Fintegra4.ing.puc.cl%2Fspree%2Fexito&cancelUrl=http%3A%2F%2Fintegra4.ing.puc.cl%2Fspree%2Ffalla&boletaId="+boletaId
        end
        url
    end
