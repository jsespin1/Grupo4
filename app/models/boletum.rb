class Boletum < ActiveRecord::Base
    ...
    def self.getUrl(boletaId)
        if Rails.env == 'development'
            ...
            url = "http://integracion-2016-dev.herokuapp.com/web/pagoenlinea?callbackUrl=http%3A%2F%2Fintegra4.ing.puc.cl%2Fexito&cancelUrl=http%3A%2F%2Fwww.emol.com&boletaId="+boletaId
        end
        url
    end
